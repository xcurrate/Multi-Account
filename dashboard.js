    ...
    getStyles() {
        ...
        <style>
            ...
            * { box-sizing: border-box; margin: 0; padding: 0; font-family: Inter, 'Segoe UI', system-ui, sans-serif; }
            ...
            .running { color: var(--green); border-color: #315f43; background: var(--green-soft); }
            .paused { color: var(--red); border-color: #6a3438; background: var(--red-soft); }
            .offline { color: var(--muted); border-color: var(--border); background: var(--panel); }
            .profile-box { display: flex; align-items: center; justify-content: center; gap: 10px; margin-top: 12px; padding: 10px; background: rgba(255,255,255,0.03); border: 1px solid var(--border); border-radius: 12px; font-weight: 500; font-size: 13px; color: var(--muted); }
            .profile-box img { width: 36px; height: 36px; border-radius: 50%; border: 1px solid var(--border); }
            .profile-preview { display: none; align-items: center; gap: 8px; margin-top: 8px; padding: 10px; background: var(--blue-soft); border: 1px solid #35406e; border-radius: 10px; color: var(--text); font-size: 13px; }
            ...
            .tab-btn.active { background: #252d5f; color: #f3f5ff; }
            ...
            .log-box { background: #0b0f15; color: #d7dde5; border: 1px solid var(--border); border-radius: 14px; padding: 0; font-family: var(--mono); font-size: 12px; line-height: 1.45; overflow-y: auto; max-height: 260px; }
            ...
            .telegram-badge { background: var(--blue-soft); border: 1px solid #35406e; border-radius: 999px; padding: 5px 9px; font-size: 11px; color: var(--accent); display: inline-block; margin-top: 8px; }
